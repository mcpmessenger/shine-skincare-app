...
def analyze_skin_enhanced():
    ...
    This endpoint uses the enhanced face analysis module with:
    1. Improved face detection and isolation
    2. Advanced skin condition analysis
    3. Demographic-aware similarity search
    4. Multiple dataset integration
    5. Comprehensive treatment recommendations
    """
    try:
        ...
        age_category = request_data.get('age_category')
        race_category = request_data.get('race_category')
        
        logger.info("🧠 Starting enhanced face analysis...")
        
        # Initialize enhanced analyzer
        analyzer = EnhancedFaceAnalyzer(use_google_vision=app.config['VISION_API_ENABLED'])
