...
# Step 3: Try SCIN dataset integration (proven working)
...
# Step 4: Try Google Vision API (for face isolation)
try:
...
def analyze_selfie():
    ...
    try:
        ...
        if GOOGLE_VISION_AVAILABLE and SCIN_AVAILABLE and AI_CORE_AVAILABLE:
            ...
            # Core AI selfie analysis (NumPy + Pillow only)
            try:
                # Read image with PIL
                image = Image.open(file.stream)
...
def analyze_skin():
    ...
    try:
        ...
        if SCIN_AVAILABLE and AI_CORE_AVAILABLE:
            ...
            # Core AI skin analysis (NumPy + Pillow only)
            try:
                # Read image with PIL
                image = Image.open(file.stream)
