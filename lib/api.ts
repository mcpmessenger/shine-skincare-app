...
export const analyzeSelfie = async (file: File): Promise<ApiResponse<{
  ...
  try {
    ...
    formData.append('image', file);
            ...
            const response = await fetch(`${this.baseUrl || 'https://awseb--AWSEB-ydAUJ3jj2fwA-1083929952.us-east-1.elb.amazonaws.com'}/api/v2/selfie/analyze`, {
      method: 'POST',
      body: formData,
    });
...
export const analyzeSkin = async (file: File): Promise<ApiResponse<{
  ...
  try {
    ...
    formData.append('image', file);
            ...
            const response = await fetch(`${this.baseUrl || 'https://awseb--AWSEB-ydAUJ3jj2fwA-1083929952.us-east-1.elb.amazonaws.com'}/api/v2/skin/analyze`, {
      method: 'POST',
      body: formData,
    });
  ...
  try {
    ...
    if (age) {
      formData.append('age', age);
            ...
            const response = await fetch(`${this.baseUrl || 'https://awseb--AWSEB-ydAUJ3jj2fwA-1083929952.us-east-1.elb.amazonaws.com'}/api/v2/medical/analyze`, {
      method: 'POST',
      body: formData,
    });
...
export const getMedicalHistory = async (user_id?: string, limit?: number): Promise<ApiResponse<{
  ...
  try {
    ...
    if (limit) params.append('limit', limit.toString());
            ...
            const response = await fetch(`${this.baseUrl || 'https://awseb--AWSEB-ydAUJ3jj2fwA-1083929952.us-east-1.elb.amazonaws.com'}/api/v2/medical/history?${params}`);
    const data = await response.json();
...
export const getMedicalAnalysisDetails = async (analysis_id: string): Promise<ApiResponse<{
  ...
  try {
            const response = await fetch(`${this.baseUrl || 'https://awseb--AWSEB-ydAUJ3jj2fwA-1083929952.us-east-1.elb.amazonaws.com'}/api/v2/medical/analysis/${analysis_id}`);
    const data = await response.json();
...
export async function processImageLightweight(imageFile: File): Promise<any> {
  try {
    ...
    formData.append('image', imageFile);
            ...
            const response = await fetch(`${this.baseUrl || 'https://awseb--AWSEB-ydAUJ3jj2fwA-1083929952.us-east-1.elb.amazonaws.com'}/api/v2/image/process-lightweight`, {
      method: 'POST',
      body: formData,
    });
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        console.log('❌ Advanced analysis failed:', advancedError);
        
        // Don't use mock data - throw error instead
        throw new Error('Advanced analysis failed. Please try again with a different image.');
      }
    }
...
export async function searchSCINWithErrorHandling(file: File, k: number = 5, conditions?: string[], skinTypes?: string[]): Promise<any> {
  try {
    ...
    try {
      ...
      // Don't use mock data - throw error instead
      throw new Error('SCIN search failed. Please try again with a different image.');
    }
...
export async function checkBackendHealth(): Promise<any> {
  try {
    ...
    const healthChecks = await Promise.allSettled([
                        fetch(`${this.baseUrl || 'https://awseb--AWSEB-ydAUJ3jj2fwA-1083929952.us-east-1.elb.amazonaws.com'}/api/v2/ai/health`),
        fetch(`${this.baseUrl || 'https://awseb--AWSEB-ydAUJ3jj2fwA-1083929952.us-east-1.elb.amazonaws.com'}/api/v2/image/process-lightweight`),
        fetch(`${this.baseUrl || 'https://awseb--AWSEB-ydAUJ3jj2fwA-1083929952.us-east-1.elb.amazonaws.com'}/api/health`)
    ]);
